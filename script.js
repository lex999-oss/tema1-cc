...
function getImage() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, ImgContainer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("http://localhost:8125/image")];
                case 1:
                    response = _a.sent();
...
function getMetrics() {
    return __awaiter(this, void 0, void 0, function () {
        var response, data, data_array, TextContainer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("http://localhost:8125/metrics_api")];
                case 1:
                    response = _a.sent();
                ...
                case 2:
                    ...
                    console.log(data);
                    TextContainer = document.getElementById("metrics");
